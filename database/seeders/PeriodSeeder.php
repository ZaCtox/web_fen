...
class PeriodSeeder extends Seeder
{
    public function run(): void
    {
        $periodos = [
            ...
            ['anio' => 2, 'numero' => 4, 'fecha_inicio' => '2026-03-01', 'fecha_fin' => '2026-05-31'],
            ['anio' => 2, 'numero' => 5, 'fecha_inicio' => '2026-06-01', 'fecha_fin' => '2026-08-31'],
            ['anio' => 2, 'numero' => 6, 'fecha_inicio' => '2026-09-01', 'fecha_fin' => '2026-11-30'],
        ];
