...
class SearchController extends Controller
{
    ...
    public function search(Request $request)
    {
        ...
        // Buscar en Salas (insensible a mayúsculas)
        try {
            ...
            \Log::warning('Error buscando salas: ' . $e->getMessage());
        }
        ...
        try {
            ...
            \Log::warning('Error buscando cursos: ' . $e->getMessage());
        }
        ...
        try {
            ...
            \Log::warning('Error buscando magisters: ' . $e->getMessage());
        }
        ...
        try {
            ...
            \Log::warning('Error buscando staff: ' . $e->getMessage());
        }
        ...
        try {
            ...
            \Log::warning('Error buscando períodos: ' . $e->getMessage());
        }
        ...
        try {
            ...
            \Log::warning('Error buscando incidencias: ' . $e->getMessage());
        }
        ...
        try {
            ...
            \Log::warning('Error buscando emergencias: ' . $e->getMessage());
        }
        ...
        try {
            ...
            \Log::warning('Error buscando clases: ' . $e->getMessage());
        }
        ...
        if ($user && $user->rol === 'administrador') {
            try {
                ...
                \Log::warning('Error buscando usuarios: ' . $e->getMessage());
            }
        }
