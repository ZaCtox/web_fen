<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
    ...
    <!-- Menú responsive con transición -->
    <div x-show="open" x-transition:enter="transition ease-out duration-200"
        ...
        class="lg:hidden bg-white dark:bg-gray-800 border-t border-gray-200 dark:border-gray-600">
        ...
        <div class="pt-2 pb-3 space-y-1">
            ...
            @else
                ...
                <a href="{{ route('login') }}"
                    class="block bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded transition duration-150 mx-2 text-center">
                    Iniciar Sesión
                </a>
            @endif
        </div>
