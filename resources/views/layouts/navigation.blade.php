...
>>>>>>> Stashed changes
                        ...
                        @if(tieneRol('administrativo'))
                            ...
                            <x-nav-link :href="route('staff.index')" :active="request()->routeIs('staff.index')">Nuestro
                                Equipo</x-nav-link>
                ...
                @if(Auth::check())
                    <div class="hidden space-x-8 lg:-my-px lg:ms-10 lg:flex">
                        ...
                        @if(tieneRol(['administrador', 'director_programa', 'asistente_programa']))
                            <x-nav-link :href="route('courses.index')"
                                :active="request()->routeIs('courses.index')">Cursos</x-nav-link>
                            <x-nav-link :href="route('magisters.index')"
                                :active="request()->routeIs('magisters.index')">Magísteres</x-nav-link>
                        @endif
...
>>>>>>> Stashed changes
            ...
            <div x-show="open" x-transition:enter="transition ease-out duration-200"
                ...
                x-transition:leave-end="opacity-0 transform -translate-x-full" class="fixed inset-y-0 left-0 w-64 bg-white dark:bg-gray-800 z-50 
           overflow-y-auto shadow-lg lg:hidden">
                    ...
                    @if(Auth::check())
                        ...
                        @if(tieneRol('administrativo'))
                            ...
                            <x-responsive-nav-link :href="route('staff.index')"
                                :active="request()->routeIs('staff.index')">Nuestro Equipo</x-responsive-nav-link>
                            <x-responsive-nav-link :href="route('usuarios.index')"
                                :active="request()->routeIs('usuarios.index')">Usuarios</x-responsive-nav-link>
                            <x-responsive-nav-link :href="route('emergencies.index')"
                                :active="request()->routeIs('emergencies.index')">Emergencias</x-responsive-nav-link>
                        @endif
                    @else
                        <x-responsive-nav-link :href="route('public.dashboard.index')"
                            :active="request()->routeIs('public.dashboard.index')">Inicio</x-responsive-nav-link>
                        <x-responsive-nav-link :href="route('public.calendario.index')"
                            :active="request()->routeIs('public.calendario.index')">Calendario</x-responsive-nav-link>
                        ...
                        <x-responsive-nav-link :href="route('public.rooms.index')"
                            :active="request()->routeIs('public.rooms.index')">Salas</x-responsive-nav-link>
                        <x-responsive-nav-link :href="route('public.courses.index')"
                            :active="request()->routeIs('public.courses.index')">Cursos</x-responsive-nav-link>

                        <!-- Botón login -->
                        <a href="{{ route('login') }}"
                            class="mt-4 block bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded text-center">
                            Iniciar Sesión
                        </a>
                    @endif
                </div>
        ...
        <div class="pt-5 pb-3 flex flex-col space-y-1 px-4">
            @if(Auth::check())
                ...
                @if(tieneRol(['administrador', 'director_programa', 'asistente_programa']))
                    <x-responsive-nav-link :href="route('courses.index')"
                        :active="request()->routeIs('courses.index')">Cursos</x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('magisters.index')"
                        :active="request()->routeIs('magisters.index')">Magísteres</x-responsive-nav-link>
                @endif

                @if(tieneRol('administrador'))
                    <x-responsive-nav-link :href="route('staff.index')" :active="request()->routeIs('staff.index')">Nuestro
                        Equipo</x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('usuarios.index')"
                        :active="request()->routeIs('usuarios.index')">Usuarios</x-responsive-nav-link>
                @endif
