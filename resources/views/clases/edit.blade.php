        ...
        <form id="form-clase" method="POST" action="{{ route('clases.update', $clase) }}" class="space-y-6"
            ...
            <div class="grid grid-cols-1 sm:grid-cols-3 gap-4">
                <div class="sm:col-span-3">
                    ...
                    <select id="periodo_info" disabled
                        ...
                        <option>{{ optional($clase->course->period)->nombre_completo ?? 'Selecciona un curso' }}
                        </option>
                    </select>
                </div>
                <div>
                    <label class="block text-sm font-semibold text-gray-700 dark:text-gray-300">Trimestre</label>
                    <input type="text" id="trimestre" value="{{ optional($clase->period)->numero }}"
                ...
                <div>
                    ...
                    <input type="text" id="anio" value="{{ optional($clase->period)->anio }}"
                        class="w-full rounded-md border-gray-300 dark:border-gray-600 bg-gray-100 dark:bg-gray-700 text-gray-500 dark:text-gray-300"
                        disabled>
                </div>
            </div>
            ...
            <div>
                ...
                <select name="modality" id="modality" x-model="modalidad"
                    class="w-full rounded-md border-gray-300 dark:border-gray-600 dark:bg-gray-800 dark:text-white"
                    required>
                    <option value="presencial" @selected(old('modality', $clase->modality) === 'presencial')>Presencial
                    </option>
                    <option value="online" @selected(old('modality', $clase->modality) === 'online')>Online</option>
                    <option value="hibrida" @selected(old('modality', $clase->modality) === 'hibrida')>Híbrida</option>
                </select>
            </div>
