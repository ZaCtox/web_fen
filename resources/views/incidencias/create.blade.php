        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 shadow-sm sm:rounded-lg p-6">
                ...
                <form action="{{ route('incidencias.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        <label for="titulo" class="block text-sm font-medium text-gray-700 dark:text-gray-200">Título</label>
                    ...
                    <div class="mb-4">
                        <label for="sala" class="block text-sm font-medium text-gray-700 dark:text-gray-200">
                            Sala afectada
                        </label>
